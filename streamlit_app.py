...
from cp_utils import (
    load_csv_auto,
@ -16,6 +14,11 @@ from cp_utils import (
)
...
def show_result_card(title: str, main_value: str, subtext: str = "", color: str = "#0b5394"):
    st.markdown("---")
@ -38,127 +41,21 @@ def show_result_card(title: str, main_value: str, subtext: str = "", color: str
